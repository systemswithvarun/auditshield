    ...
    <div className="min-h-screen bg-[#f8f9ff] flex flex-col items-center justify-center p-4 selection:bg-[#22C55E]/10 selection:text-[#006e2f]">
      <div className="w-full max-w-[400px] bg-white rounded-3xl border border-black/10 overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.06)] relative animate-in fade-in zoom-in-[0.98] duration-500">
        <div className="px-8 pt-8 pb-5 border-b border-black/5">
          ...
          <h1 className="text-[22px] font-medium text-[#0d1c2d] tracking-tight mb-1.5">Reset Password</h1>
          <p className="text-[14px] text-[#45464d] leading-[1.5]">Enter your email to receive a recovery link.</p>
        </div>
        ...
        {success ? (
          <div className="p-8 pb-10 flex flex-col items-center text-center gap-4">
            ...
            <h2 className="text-[18px] font-medium text-[#0d1c2d]">Check your inbox</h2>
            <p className="text-[14px] text-[#45464d] leading-[1.5]">
              We've sent a password recovery link to <strong>{email}</strong>.
            </p>
            <Link 
              href="/login"
              className="w-full h-[52px] bg-white border border-black/10 text-[#0d1c2d] rounded-xl text-[15px] font-medium tracking-[-0.2px] transition-all hover:bg-[#eef4ff] active:scale-[0.99] flex items-center justify-center mt-4 shadow-sm"
            >
              Back to Login
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 pb-10 flex flex-col gap-5">
            ...
            <p className="text-center text-[13px] text-[#45464d] mt-3">
              Remember your password? <Link href="/login" className="text-[#0d1c2d] font-medium hover:underline">Log in</Link>
            </p>
          </form>
        )}
      </div>
